...
function Navbar({ onDarkMode, darkMode }) {
      ...
      <nav className="container px-2 lg:max-w-[1114px] flex flex-wrap items-center justify-between mx-auto py-4 ">
          ...
          <div className="flex items-center">
            ...
            <button className="p-2 text-sm text-black dark:text-white rounded-lg md:hidden" onClick={handleShowOptions}>
             { 
                ...
                : <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path></svg>
              }
            </button>
          </div>
        </div>
        <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 transition-all duration-500 ${showOptions ? '' : 'hidden'}`}>
          <ul className="flex flex-col gap-6 p-4 md:p-0 mt-4 font-medium  md:flex-row  md:mt-0 md:border-0" onClick={handleShowOptions}>
            <li className="text-center"><a href="/#projects" className="relative overflow-hidden z-10 p-2 before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0 before:bg-white before:backdrop-blur-lg before:rounded-lg rounded-xl before:-z-10 before:transition-all before:duration-500 before:hover:w-full transition-all duration-300 dark:text-emerald-400 hover:text-white dark:text-dark-200 dark:hover:text-white font-bold">Proyectos</a></li>
            <li className="text-center"><a href="/#experience" className="relative overflow-hidden z-10 p-2 before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0 before:bg-white before:backdrop-blur-lg before:rounded-lg rounded-xl before:-z-10 before:transition-all before:duration-500 before:hover:w-full transition-all duration-300 dark:text-emerald-400 hover:text-white dark:text-dark-200 dark:hover:text-white font-bold">Experiencia</a></li>
            <li className="text-center"><a href="/#tecnologies" className="relative overflow-hidden z-10 p-2 before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0 before:bg-white before:backdrop-blur-lg before:rounded-lg rounded-xl before:-z-10 before:transition-all before:duration-500 before:hover:w-full transition-all duration-300 dark:text-emerald-400 hover:text-white dark:text-dark-200 dark:hover:text-white font-bold">Tecnologías</a></li>
          </ul>
        </div>
      </nav>
  );
  ...
  return (
    <nav className=" container bg-red-400 px-2 lg:max-w-[1114px] flex flex-wrap items-center justify-between mx-auto py-4 ">
      <img src={icon} alt="icon" className="h-20 ms-2 lg:h-24 xl:h-28"/>
      ...
      <div className="md:order-2">
        ...
        <div className="flex items-center">
          <button className="bg-white p-1 rounded-md  md:hidden" title="Theme switcher button"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className="text-dark-700 hover:text-dark-500 dark:text-dark-300 dark:hover:text-dark-500 transition-colors duration-300 cursor-pointer" height="20" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M277.3 32h-42.7v64h42.7V32zm129.1 43.7L368 114.1l29.9 29.9 38.4-38.4-29.9-29.9zm-300.8 0l-29.9 29.9 38.4 38.4 29.9-29.9-38.4-38.4zM256 128c-70.4 0-128 57.6-128 128s57.6 128 128 128 128-57.6 128-128-57.6-128-128-128zm224 106.7h-64v42.7h64v-42.7zm-384 0H32v42.7h64v-42.7zM397.9 368L368 397.9l38.4 38.4 29.9-29.9-38.4-38.4zm-283.8 0l-38.4 38.4 29.9 29.9 38.4-38.4-29.9-29.9zm163.2 48h-42.7v64h42.7v-64z"></path></svg></button>
          <button className="p-2 text-sm text-dark-700 dark:text-dark-200 rounded-lg md:hidden"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path></svg></button>
        </div>
        <div className="items-center justify-between w-full md:flex md:w-auto md:order-1 transition-all duration-500">
          <ul class="flex flex-col gap-6 p-4 md:p-0 mt-4 font-medium  md:flex-row  md:mt-0 md:border-0 ">
            <li class="text-center">
              <a class="relative overflow-hidden z-10 p-2  before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0 before:bg-primary-500 before:backdrop-blur-lg before:rounded-lg  rounded-xl before:-z-10 before:transition-all before:duration-500 before:hover:w-full  transition-all duration-300 text-dark-700 hover:text-dark-900 dark:text-dark-200 dark:hover:text-dark-50" href="/projects">Proyectos</a></li><li class="text-center"><a href="/#experience" class="relative overflow-hidden z-10 p-2  before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0 before:bg-primary-500 before:backdrop-blur-lg before:rounded-lg  rounded-xl before:-z-10 before:transition-all before:duration-500 before:hover:w-full  transition-all duration-300 text-dark-700 hover:text-dark-900 dark:text-dark-200 dark:hover:text-dark-50">Experiencia</a></li><li class="text-center"><a class="relative overflow-hidden z-10 p-2  before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0 before:bg-primary-500 before:backdrop-blur-lg before:rounded-lg  rounded-xl before:-z-10 before:transition-all before:duration-500 before:hover:w-full  transition-all duration-300 text-dark-700 hover:text-dark-900 dark:text-dark-200 dark:hover:text-dark-50" href="/services">Desarrollo web</a></li><li class="text-center"><a class="relative overflow-hidden z-10 p-2  before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0 before:bg-primary-500 before:backdrop-blur-lg before:rounded-lg  rounded-xl before:-z-10 before:transition-all before:duration-500 before:hover:w-full  transition-all duration-300 text-dark-700 hover:text-dark-900 dark:text-dark-200 dark:hover:text-dark-50" href="/posts">Blog</a></li></ul>
        </div>
      </div>
    </nav>
  );
