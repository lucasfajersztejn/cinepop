      ...
      <nav className="container px-2 lg:max-w-[75%] flex flex-wrap items-center justify-between lg:justify-around mx-auto py-4 ">
        ...
        <div className="md:order-2">
          ...
          <div className="flex items-center">
            ...
            <button className="p-2 text-sm text-white rounded-lg md:hidden" onClick={handleShowOptions}>
             { 
                showOptions
        ...
        <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 transition-all duration-500 ${showOptions ? '' : 'hidden'}`}>
          <ul className="flex flex-col gap-6 p-4 md:p-0 mt-4 font-medium  md:flex-row  md:mt-0 md:border-0" onClick={handleShowOptions}>
            <li className="text-center"><NavLink to="/movies" className="relative overflow-hidden text-2xl z-10 p-2 before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0  before:backdrop-blur-lg before:rounded-lg rounded-xl before:-z-10 before:hover:w-full transition-all text-white hover:text-red-300 dark:text-dark-200 dark:hover:text-red-400 font-bold">Movies</NavLink></li>
            <li className="text-center"><NavLink to="/cinemas" className="relative overflow-hidden text-2xl z-10 p-2 before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-0 before:backdrop-blur-lg before:rounded-lg rounded-xl before:-z-10 before:hover:w-full transition-all text-white hover:text-red-300 dark:text-dark-200 dark:hover:text-red-400 font-bold">Cinemas</NavLink></li>
